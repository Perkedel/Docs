...
The prophecy, despite of all efforts, ultimately still had to become true

## Begin

Your homescreen turned into serious room. All your characters are this time gone, for real. And now it's just Atmin, officers, and the same metal desk used to interogate Gusti in Sign up level.

Click Atmin to start the presentation now.

You have now sat on this chair before Atmin and the officers.
...
A screenshot of Chatbot helper of Ban notice taken from Kaorfa's DM after this ban over Discord servers

Atmin: Your Steam Account allegedly is connected to the same Discord account you used to ban Kaorfa across most Cardiophilia Discord Servers and Tumblr accounts, is that correct?
...
Only choice to click, `Look, I can sue you, you know. Don't even try ruin my life over these`
...
You are logged out, go to Init Scene

## Changes

Your Save card now says `Permanently Banned`, and `Login` button label changes to `View Info`.

## End

[Next](/Lores/ValveCorporation/sANDcardiophilia-inevitable_loss.md)
