# s&Cardiophilia trailer: Parasocial version
...
- Vibe assets used
  - Normal.
    - Bright and happy
  - Criminal punishment horror
    - Creepy and silent. No music
    - Extreme guilt. You've done a great grave mistake to somebody.
    - As if you accuse, which is more cruel than murder.

## Begin

Some gameplay footage of s&cardiophilia

Trah: At last. Your long awaited heartbeat cardiophilia game is here.

switch vibe to horror serious mode as if you activated server cheat on Stanley Parable Unity

Trah: But this game is not for you.

.

.

Trah: You have been punished for ruining the OG Kaorfa's life back then.
...
stimulation activities. Show marathon Doom-like minigame

Trah: Stimulation, to increase their heart rate. Or..
...
Trah: Because our Heart organs maintainer machine keeps them alive, at least to their brain.

Show moment when Anni cardiac arrest. Demonstrate this one click button to resus back online immediately

Trah: And of course, **No complicated gameplay**.

Show the same again but Luna. This time to demonstrate manually CPR, in case the gamer's into CPR fetish. But it's still easy, just concern mouth breath & tap tap tap until she eventually back online.

Trah: Or perhaps do it manually. (confused to why exist people likes to sell themselves short)... if that's what you want.. still very easy tho.

Jump cut to Luna alive online again. Like a diesel engine with broken starter successfully started again

Trah: Yeah. Also,

few-seconds video compilation of various activities possible in s&Cardiophilia, including FPS DOOM-like complete with intuitive and fun Doom-quake always run controls

Trah: There's more!, Feedbacks welcome.

and finally to show the most important thing. ECG Daemon menu listing characters on scene. Is every live character appeared on scene tree has heart organ and hence will click the cookie for you
...
Developed by Pinball Agung Indonesia logo. `Developed by`, `Pinball Agung ID`.
...
s&cardiophilia title logo with Platform logos
